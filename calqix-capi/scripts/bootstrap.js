...
async function createObservabilitySchedules() {
  ...
  try {
    ...
    var schedules = [
      { id: SCHEDULE_ID_IDENTITY_BACKFILL, endpoint: '/api/cron/identity-backfill', cron: 'CRON_TZ=Europe/Amsterdam */15 * * * *' },
      { id: SCHEDULE_ID_BRIDGE_HEALTH, endpoint: '/api/cron/bridge-health', cron: 'CRON_TZ=Europe/Amsterdam */10 * * * *' },
